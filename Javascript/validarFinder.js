	...
	function validarDatosUsuario() {
		...
		// Validación de la selección de tipo de documento
	...
	function layerConfig(capa) 				{	if(controlConfig%2>0) mostrardiv(capa); else cerrar(capa); controlConfig++; }
	...
	function mostrarCreditDiv(division) 	{ 	div = document.getElementById(division);	div.style.display = "block"; };
	function cerrarCreditDiv(division) 		{	div = document.getElementById(division);	div.style.display="none"; };	
