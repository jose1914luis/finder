<?php
	...
	if(!empty($dataSET))	$tfoot = generaPaginacion("?mnu=creditos", $pags_pantalla, $pagina_actual, $total_paginas, $max_por_pagina);
	else					$tfoot = "<b><i>No reporta consumo de Cr&eacute;ditos</i></b>";

?>

<form name="frmCreditos" method="post" action="?mnu=creditos_compra" target="_blank">
	<table width="95%" border="0" align="center" cellspacing="0" class="tableFonts">
		<tr>
			<td colspan="2" class="titleSite" align='center'>Mis Cr&eacute;ditos</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		<tr bgcolor="yellow">
			<td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total de Cr&eacute;ditos disponibles:<b/></td>
			<td >
				<div id="totalCreditos"><h3><font color="green"><?=$_SESSION['usr_cred']['credito']?> Cr&eacute;dito(s)</font></h3></div>
			</td>
		</tr>	
		<tr>
		...
		<tr>
			<td><b>Compra de nuevos cr&eacute;ditos (1 Cr&eacute;dito <=> 1000 COP):</b></td>
			<td valign="middle">
				<table border="0">
					<tr>
						<td><input type="text" name="txtCompraCreditos" placeholder="Mínimo <?=$GLOBALS ["SIGCoin_minimo"]?> COP" onchange="this.value=Math.floor(this.value/1000)*1000"/></td>
						<td>&nbsp;&nbsp;</td>
						<td><a href="javascript:" onclick="document.frmCreditos.submit()"/><img src="Imgs/enviarPago.png" border="0" width="181" height="39"></a></td>
					</tr>
				</table>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<table class="results" align="center" width="100%">	
					<caption>
