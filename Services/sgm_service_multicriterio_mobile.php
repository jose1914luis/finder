<?php
	...
	if(@trim($_GET["multicriterio"])!="") {	
		...
		$listaExpedientesResults["solicitudes"] 	= $res->selectSolicitudesByListaCampos_mobile($_GET["multicriterio"]);
		$listaExpedientesResults["titulos"]			= $res->selectTitulosByListaCampos_mobile($_GET["multicriterio"]);
