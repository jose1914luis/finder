...
<html>
  ...
  <body onLoad="init()" onunload='$("#loadingImage").hide()'>
	...
	<?php 
		$menuSuperior = '
			<ul class="navHorizontal">		
				<li class="navHorizontal"><a href="javascript:" class="active navHorizontal">Reporte</a></li>
				<li class="navHorizontal"><a href="javascript:" class="navHorizontal">Anotaciones</a></li>
				<li class="navHorizontal"><a href="javascript:" class="navHorizontal">Notificaciones</a></li>
			</ul>		
		';
