<?php
	...
	$nombre_archi	= $_REQUEST['reference_sale']."_dePrueba.txt";
	...
	if (strtoupper($firma) == strtoupper($firmacreada)) {
		if ($_REQUEST['state_pol'] == 4 ) {
			...
			$resp  = "OK";  //$pagos->habilitarConsignacion($_REQUEST['reference_sale'], $_REQUEST['value']);			
			...
			if($resp=='OK') {
				...
				*/	
					...
					$cred->comprarCreditos($datos_usr["id_usuario"], floor($datos_usr["precio"]/$GLOBALS["SIGCoin_pesos"]));
